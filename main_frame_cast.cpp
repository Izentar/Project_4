...
void Main_frame::recursion_save_to_file_hierarchy(Main_frame::Frame* frame, ofstream& saving)
{
...
{
    ofstream saving;
    saving.open("objects.bin", ios::trunc|ios::binary);
    if(!saving.good())
    {
        return true;
    }
    ...
    {
       // this->recursion_save_to_file_objects(saving);
    }
