...
{
private:
    static const int DEFAULT_FRAME=3;

protected:
    string inscription;

public:
    Frame_inscription(Main_frame* window, Main_frame::Frame* f_frame, string inscript, const int& pos_x, const int& pos_y, const int& F_width=DEFAULT_FRAME, const int& F_height=DEFAULT_FRAME, \
        string f_name=UNDEFINED, const char& filling_edges_x=DEFAULT_VOID,  const char& filling_edges_y=DEFAULT_VOID, const char& filling_corner_ur=DEFAULT_VOID, \
    ...
    Frame_inscription(Main_frame* window, nullptr_t ,string inscript, const int& pos_x, const int& pos_y, const int& F_width=DEFAULT_FRAME, const int& F_height=DEFAULT_FRAME, \
